  ...
  .ports = {
    {
      ...
      .pads = {
        ...
        /*PTA18*/ PAL_MODE_INPUT_ANALOG,    /*PTA19*/ PAL_MODE_INPUT_PULLUP,    /*PTA20*/ PAL_MODE_ALTERNATIVE_7,
    ...
    },
    {
      .port = IOPORT2,  // PORTB
      .pads = {
        /* PTB0*/ PAL_MODE_OUTPUT_PUSHPULL, /* PTB1*/ PAL_MODE_OUTPUT_PUSHPULL,   /* PTB2*/ PAL_MODE_ALTERNATIVE_3,
    ...
    },
    {
      .port = IOPORT3,  // PORTC
      .pads = {
        /* PTC0*/ PAL_MODE_UNCONNECTED,     /* PTC1*/ PAL_MODE_INPUT_PULLUP,    /* PTC2*/ PAL_MODE_INPUT_PULLUP,
        /* PTC3*/ PAL_MODE_INPUT,           /* PTC4*/ PAL_MODE_INPUT_PULLUP,    /* PTC5*/ PAL_MODE_ALTERNATIVE_2,
	...
	/* PTD0*/ PAL_MODE_OUTPUT_PUSHPULL, /* PTD1*/ PAL_MODE_UNCONNECTED,     /* PTD2*/ PAL_MODE_UNCONNECTED,
        ...
        /* PTD6*/ PAL_MODE_INPUT_PULLUP,    /* PTD7*/ PAL_MODE_OUTPUT_PUSHPULL, /* PTD8*/ PAL_MODE_UNCONNECTED,
