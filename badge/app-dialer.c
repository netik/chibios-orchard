...
#define DIALER_SAMPLERATE 29700

static const DIALER_BUTTON buttons[] =  {
	{ 0,   0,   "1",     1209, 697,  504  },
	{ 60,  0,   "2",     1336, 697,  462  },
	{ 120, 0,   "3",     1477, 697,  420  },
	{ 180, 0,   "A",     1633, 697,  504  }, 

	{ 0,   60,  "4",     1209, 770,  456  },
	{ 60,  60,  "5",     1336, 770,  418  },
	{ 120, 60,  "6",     1477, 770,  760  },
	{ 180, 60,  "B",     1633, 770,  684  }, 

	{ 0,   120, "7",     1209, 852,  408  },
	{ 60,  120, "8",     1336, 852,  748  },
	{ 120, 120, "9",     1477, 852,  680  },
	{ 180, 120, "C",     1633, 852,  612  }, 

	{ 0,   180, "*",     1209, 941,  744  },
	{ 60,  180, "0",     1336, 941,  682  },
        { 120, 180, "#",     1477, 941,  620  },
	{ 180, 180, "D",     1633, 941,  558  },

	{ 0,   240, "2600",  2600, 2600, 484  },
	...
	{ 0,   0,   "1",     700,  900,  462  },
	{ 60,  0,   "2",     700,  1100, 756  },
	{ 120, 0,   "3",     900,  1100, 594  },
	{ 180, 0,   "KP1",   1100, 1700, 459  }, 

	{ 0,   60,  "4",     700,  1300, 462  },
	{ 60,  60,  "5",     900,  1300, 528  },
	{ 120, 60,  "6",     1100, 1300, 594  },
	{ 180, 60,  "KP2",   1300, 1700, 748  }, 

	{ 0,   120, "7",     700,  1500, 798  },
	{ 60,  120, "8",     900,  1500, 627  },
	{ 120, 120, "9",     1100, 1500, 513  },
	{ 180, 120, "ST",    1500, 1700, 646  }, 

	{ 0,   180, "Code1", 700,  1700, 714  },
	{ 60,  180, "0",     1300, 1500, 418  },
        { 120, 180, "Code2", 900,  1700, 561  },
	{ 180, 180,  "",     0,    0,    0    },
...
tonePlay (GWidgetObject * w, uint8_t b, uint32_t duration)
{
	...
	for (i = 0; i < samples; i++) {
		point1 = fract1 * i;
		result = 2047 + (fast_sin (point1) * 2047);
		point2 = fract2 * i;
		result += 2047 + (fast_sin (point2) * 2047);
		result /= 2.0;
